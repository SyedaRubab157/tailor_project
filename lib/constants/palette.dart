...
const primary = Color(0xFF223A5E  );
// const tertiary = Colors.amber;
const tertiary = Color(0xFF208399);
// const secondary = Color(0xffBCC2C8);
const secondary = Color(0xFF144955);
// const lightColor = Color(0xffF1F5F9);
const tertiaryContainer = Color(0xFFCCF3FF);
const primaryContainer = Color(0xFF97BAEA);
Color lightColor = Color(0xFF97BAEA).withAlpha(50);
...
class MyTextStyles {
  ...
  static TextStyle headingSmallWhite = TextStyle(
    ...
    fontFamily: GoogleFonts.fjallaOne().fontFamily, // Specify the Google Font
  );
  ...
  static TextStyle subHeadingBoldWhite16 = TextStyle(
    color: Colors.white,
...
// black ***********************
  ...
  static TextStyle headingSmallBlack = TextStyle(
    ...
    fontSize: 18,
    fontWeight: FontWeight.bold,
    fontFamily: GoogleFonts.prompt().fontFamily, // Specify the Google Font
